...
import com.nukkitx.protocol.bedrock.v390.BedrockPacketReader_v390;
...
public class BedrockPacketReader_v407 extends BedrockPacketReader_v390 {
    public static final BedrockPacketReader_v407 INSTANCE = new BedrockPacketReader_v407();

    protected final Int2ObjectBiMap<StackRequestActionType> stackRequestActionTypes = new Int2ObjectBiMap<>();

    protected BedrockPacketReader_v407() {
        super();
    ...
    protected void registerEntityData() {
        ...
        this.addEntityData(113, EntityDataType.LOW_TIER_CURED_TRADE_DISCOUNT);
        this.addEntityData(114, EntityDataType.HIGH_TIER_CURED_TRADE_DISCOUNT);
        this.addEntityData(115, EntityDataType.NEARBY_CURED_TRADE_DISCOUNT);
        this.addEntityData(116, EntityDataType.NEARBY_CURED_DISCOUNT_TIME_STAMP);
        this.addEntityData(117, EntityDataType.HITBOX);
        this.addEntityData(118, EntityDataType.IS_BUOYANT);
        this.addEntityData(119, EntityDataType.BUOYANCY_DATA);
    }
