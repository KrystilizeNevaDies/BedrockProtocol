...
@UtilityClass
public class Bedrock_v440 {
    public static BedrockPacketCodec V440_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(440)
            .minecraftVersion("1.17.0")
            .helper(BedrockPacketReader_v440.INSTANCE)
            ...
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoReader_v422.INSTANCE, 6)
