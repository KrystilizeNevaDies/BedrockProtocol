...
import com.nukkitx.protocol.bedrock.v486.BedrockPacketReader_v486;
import io.netty.buffer.ByteBuf;

public class BedrockPacketReader_v503 extends BedrockPacketReader_v486 {
    public static final BedrockPacketReader_v503 INSTANCE = new BedrockPacketReader_v503();

    @Override
    protected void registerEntityData() {
        super.registerEntityData();

        this.addEntityData(125, EntityDataType.MOVEMENT_SOUND_DISTANCE_OFFSET);
        this.addEntityData(126, EntityDataType.HEARTBEAT_INTERVAL_TICKS);
        this.addEntityData(127, EntityDataType.HEARTBEAT_SOUND_EVENT);
    }
