...
public class Bedrock_v503 {
    public static BedrockPacketCodec V503_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(503)
            .minecraftVersion("1.18.30")
            .helper(BedrockPacketReader_v503.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReader_v503.INSTANCE, 11)
