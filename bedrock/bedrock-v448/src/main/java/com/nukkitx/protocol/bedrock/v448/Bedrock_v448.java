...
public class Bedrock_v448 {
    public static BedrockPacketCodec V448_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(448)
            .minecraftVersion("1.17.10")
            .helper(BedrockPacketReader_v448.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReader_v440.INSTANCE, 11)
            ...
            .registerPacket(AddVolumeEntityPacket.class, AddVolumeEntityReader_v440.INSTANCE, 166)
