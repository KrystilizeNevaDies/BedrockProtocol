...
public class Bedrock_v354 {
    public static final BedrockPacketCodec V354_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v354.INSTANCE)
            ...
            .registerPacket(CraftingDataPacket.class, CraftingDataReader_v354.INSTANCE, 52)
            ...
            .registerPacket(LecternUpdatePacket.class, LecternUpdateReader_v354.INSTANCE, 124)
            .registerPacket(VideoStreamConnectPacket.class, VideoStreamConnectReader_v340.INSTANCE, 125)
            .registerPacket(MapCreateLockedCopyPacket.class, MapCreateLockedCopyReader_v354.INSTANCE, 126)
            .registerPacket(OnScreenTextureAnimationPacket.class, OnScreenTextureAnimationReader_v354.INSTANCE, 127)
            .build();
}
