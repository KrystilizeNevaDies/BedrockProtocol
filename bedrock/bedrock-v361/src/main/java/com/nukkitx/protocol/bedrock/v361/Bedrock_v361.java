...
public class Bedrock_v361 {
    public static BedrockPacketCodec V361_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v361.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReader_v361.INSTANCE, 11)
            ...
            .registerPacket(CraftingDataPacket.class, CraftingDataReader_v361.INSTANCE, 52)
            ...
            .registerPacket(EventPacket.class, EventReader_v354.INSTANCE, 65)
            ...
            .registerPacket(AvailableCommandsPacket.class, AvailableCommandsReader_v340.INSTANCE, 76)
            ...
            .registerPacket(StructureBlockUpdatePacket.class, StructureBlockUpdateReader_v361.INSTANCE, 90)
            ...
            .registerPacket(StructureTemplateDataResponsePacket.class, StructureTemplateDataResponseReader_v361.INSTANCE, 133)
