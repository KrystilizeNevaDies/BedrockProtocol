...
public class Bedrock_v471 {
    public static BedrockPacketCodec V471_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v471.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReader_v465.INSTANCE, 11)
            ...
            .registerPacket(SubChunkPacket.class, SubChunkReader_v471.INSTANCE, 174)
