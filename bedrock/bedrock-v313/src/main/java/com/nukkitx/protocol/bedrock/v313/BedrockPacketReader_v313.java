...
import com.nukkitx.protocol.bedrock.v291.BedrockPacketReader_v291;
import io.netty.buffer.ByteBuf;
import lombok.AccessLevel;
import lombok.NoArgsConstructor;

import static com.nukkitx.protocol.bedrock.data.SoundEvent.*;
import static com.nukkitx.protocol.bedrock.data.entity.EntityDataType.*;


@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class BedrockPacketReader_v313 extends BedrockPacketReader_v291 {

    public static final BedrockPacketHelper INSTANCE = new BedrockPacketReader_v313();
