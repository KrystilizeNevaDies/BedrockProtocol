...
public final class Bedrock_v313 {
    public static final BedrockPacketCodec V313_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v313.INSTANCE)
            ...
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoReader_v291.INSTANCE, 6)
            ...
            .registerPacket(TextPacket.class, TextReader_v291.INSTANCE, 9)
            .registerPacket(SetTimePacket.class, SetTimeReader_v291.INSTANCE, 10)
            .registerPacket(StartGamePacket.class, StartGameReader_v313.INSTANCE, 11)
            ...
            .registerPacket(AddPaintingPacket.class, AddPaintingReader_v291.INSTANCE, 22)
            ...
            .registerPacket(EventPacket.class, EventReader_v291.INSTANCE, 65)
            ...
            .registerPacket(NetworkStackLatencyPacket.class, NetworkStackLatencyReader_v291.INSTANCE, 115)
            .registerPacket(ScriptCustomEventPacket.class, ScriptCustomEventReader_v291.INSTANCE, 117)
            .registerPacket(SpawnParticleEffectPacket.class, SpawnParticleEffectReader_v313.INSTANCE, 118)
