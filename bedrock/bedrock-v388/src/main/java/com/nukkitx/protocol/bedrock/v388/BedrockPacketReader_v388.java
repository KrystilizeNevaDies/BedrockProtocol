...
import com.nukkitx.protocol.bedrock.v361.BedrockPacketReader_v361;
...
public class BedrockPacketReader_v388 extends BedrockPacketReader_v361 {
    public static final BedrockPacketReader_v388 INSTANCE = new BedrockPacketReader_v388();
    ...
    protected void registerEntityData() {
        ...
        this.addEntityData(107, EntityDataType.AMBIENT_SOUND_INTERVAL);
        this.addEntityData(108, EntityDataType.AMBIENT_SOUND_INTERVAL_RANGE);
        this.addEntityData(109, EntityDataType.AMBIENT_SOUND_EVENT_NAME);
        this.addEntityData(110, EntityDataType.FALL_DAMAGE_MULTIPLIER);
        this.addEntityData(111, EntityDataType.NAME_RAW_TEXT);
        this.addEntityData(112, EntityDataType.CAN_RIDE_TARGET);
    }
    ...
    public AnimationData readAnimationData(ByteBuf buffer) {
        ...
        AnimatedTextureType valueType = TEXTURE_TYPES[buffer.readIntLE()];
        float frames = buffer.readFloatLE();
        return new AnimationData(image, valueType, frames);
    }
