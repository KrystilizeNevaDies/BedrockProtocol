...
public class Bedrock_v408 {
    public static BedrockPacketCodec V408_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v407.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReader_v407.INSTANCE, 11)
            ...
            .registerPacket(ItemStackResponsePacket.class, ItemStackResponseReader_v407.INSTANCE, 148)
