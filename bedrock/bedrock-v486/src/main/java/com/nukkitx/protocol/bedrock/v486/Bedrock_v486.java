...
@UtilityClass
public class Bedrock_v486 {
    public static BedrockPacketCodec V486_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(486)
            .minecraftVersion("1.18.10")
            .helper(BedrockPacketReader_v486.INSTANCE)
            ...
            .registerPacket(AddVolumeEntityPacket.class, AddVolumeEntityReader_v486.INSTANCE, 166)
