...
public class BedrockBeta {
    public static BedrockPacketCodec BETA_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReaderBeta.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameReaderBeta.INSTANCE, 11)
            .registerPacket(AddPlayerPacket.class, AddPlayerReader_v503.INSTANCE, 12)
            ...
            .registerPacket(PlayerActionPacket.class, PlayerActionReaderBeta.INSTANCE, 36)
            ...
            .registerPacket(LevelChunkPacket.class, LevelChunkReader_v486.INSTANCE, 58)
            ...
            .registerPacket(BossEventPacket.class, BossEventReader_v486.INSTANCE, 74)
            ...
            .registerPacket(SpawnParticleEffectPacket.class, SpawnParticleEffectReader_v503.INSTANCE, 118)
            ...
            .registerPacket(AddVolumeEntityPacket.class, AddVolumeEntityReader_v503.INSTANCE, 166)
            .registerPacket(RemoveVolumeEntityPacket.class, RemoveVolumeEntityReader_v503.INSTANCE, 167)
            ...
            .registerPacket(SubChunkPacket.class, SubChunkReader_v486.INSTANCE, 174)
            .registerPacket(SubChunkRequestPacket.class, SubChunkRequestReader_v486.INSTANCE, 175)
            .registerPacket(PlayerStartItemCooldownPacket.class, PlayerStartItemCooldownReader_v486.INSTANCE, 176)
            .registerPacket(ScriptMessagePacket.class, ScriptMessageReader_v486.INSTANCE, 177)
            .registerPacket(CodeBuilderSourcePacket.class, CodeBuilderSourceReader_v486.INSTANCE, 178)
            .registerPacket(TickingAreasLoadStatusPacket.class, TickingAreasLoadStatusReader_v503.INSTANCE, 179)
            .registerPacket(DimensionDataPacket.class, DimensionDataReader_v503.INSTANCE, 180)
            .registerPacket(AgentActionEventPacket.class, AgentActionEventReader_v503.INSTANCE, 181)
            .registerPacket(ChangeMobPropertyPacket.class, ChangeMobPropertyReader_v503.INSTANCE, 182)
            .registerPacket(LessonProgressPacket.class, LessonProgressReaderBeta.INSTANCE, 183)
            .registerPacket(RequestAbilityPacket.class, RequestAbilityReaderBeta.INSTANCE, 184)
            .registerPacket(RequestPermissionsPacket.class, RequestPermissionsReaderBeta.INSTANCE, 185)
            .registerPacket(ToastRequestPacket.class, ToastRequestReaderBeta.INSTANCE, 186)
            .build();
}
