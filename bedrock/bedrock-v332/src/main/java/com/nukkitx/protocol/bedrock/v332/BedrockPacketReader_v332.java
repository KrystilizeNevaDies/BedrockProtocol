...
import com.nukkitx.protocol.bedrock.v313.BedrockPacketReader_v313;
...
public class BedrockPacketReader_v332 extends BedrockPacketReader_v313 {

    public static final BedrockPacketHelper INSTANCE = new BedrockPacketReader_v332();
    ...
    protected void registerEntityData() {
        ...
        this.addEntityData(94, EntityDataType.AREA_EFFECT_CLOUD_DURATION);
        this.addEntityData(95, EntityDataType.AREA_EFFECT_CLOUD_SPAWN_TIME);
        this.addEntityData(96, EntityDataType.AREA_EFFECT_CLOUD_CHANGE_RATE);
        this.addEntityData(97, EntityDataType.AREA_EFFECT_CLOUD_CHANGE_ON_PICKUP);
        this.addEntityData(98, EntityDataType.AREA_EFFECT_CLOUD_COUNT);
    }
