...
public class Bedrock_v340 {
    public static final BedrockPacketCodec V340_CODEC = BedrockPacketCodec.builder()
            ...
            .helper(BedrockPacketReader_v340.INSTANCE)
            ...
            .registerPacket(EventPacket.class, EventReader_v340.INSTANCE, 65)
            ...
            .registerPacket(StructureBlockUpdatePacket.class, StructureBlockUpdateReader_v340.INSTANCE, 90)
            ...
            .registerPacket(LecternUpdatePacket.class, LecternUpdateReader_v340.INSTANCE, 124)
