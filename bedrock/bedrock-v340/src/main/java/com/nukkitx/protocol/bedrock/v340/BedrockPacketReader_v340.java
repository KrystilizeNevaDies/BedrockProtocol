...
import com.nukkitx.protocol.bedrock.v332.BedrockPacketReader_v332;
...
public class BedrockPacketReader_v340 extends BedrockPacketReader_v332 {

    public static final BedrockPacketHelper INSTANCE = new BedrockPacketReader_v340();
    ...
    protected void registerEntityData() {
        ...
        this.addEntityData(39, EntityDataType.HAS_NPC_COMPONENT);

        this.addEntityData(99, EntityDataType.INTERACTIVE_TAG);
        this.addEntityData(100, EntityDataType.TRADE_TIER);
        this.addEntityData(101, EntityDataType.MAX_TRADE_TIER);
    }
